...
npm run round:advance -- --coordinator-url <coordinator-url> --phase auto --jobs-dir .marshall/runs/<run-id>/jobs --artifact-store-dir <control-artifact-store> --eval-file <eval.jsonl> --eval-kind instruction_terms --model <base-model> --max-examples <n> --max-tokens <n>
npm test
...
npm run dataset:run:prepare -- --dataset-dir <dataset-dir> --run-id <run-id> --run-dir .marshall/runs/<run-id> --job-count <n> --job-id-prefix <train-job-prefix> --model <base-model> --publish true --coordinator-url <coordinator-url>
npm run round:daemon -- --coordinator-url <coordinator-url> --run-id <run-id> --round-id <round-id> --jobs-dir .marshall/runs/<run-id>/jobs --train-job-prefix <train-job-prefix> --eval-job-prefix <eval-job-prefix> --validation-job-prefix <validation-job-prefix> --eval-file <eval.jsonl> --eval-uri <worker-resolvable-eval-uri> --eval-kind instruction_terms --model <base-model> --max-examples <n> --max-tokens <n> --validators-per-artifact 2 --quorum 2 --min-accuracy <n> --max-invalid-rate <n> --min-examples <n> --artifact-store-dir <control-artifacts> --leaderboard-dir <leaderboard-dir> --package-dir <package-dir> --top-k <n> --require-verdict accepted
npm run worker:join -- --control <control-multiaddr> --worker-id-base <machine-id> --state-dir .marshall/public-worker --train-concurrency <n> --eval-concurrency <n> --validation-concurrency <n> --python <mlx-python>
```
