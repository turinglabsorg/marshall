...
Run/job publisher
      |
Go coordinator replicas + Redis  <---- public dashboard
      |
...
- GCP small-VM deployment with Caddy HTTPS, local Redis, active-active coordinator services, and multi-control peer services.
