...
const server = await createChatServer({
  ...
  modelRegistryPath: args["model-registry-path"] ?? process.env.MARSHALL_MODEL_REGISTRY_PATH,
  modelRegistryUrl: args["model-registry-url"] ?? process.env.MARSHALL_MODEL_REGISTRY_URL,
