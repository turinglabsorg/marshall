...
const controlAddr = requiredArg("control", args.control ?? process.env.MARSHALL_CONTROL_ADDR);
...
const controlAddrs = parseControlAddrs(controlAddr);
...
function parseControlAddrs(primary: string) {
  const values = [
    ...splitList(primary),
